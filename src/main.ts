...
const availableItems: Item[] = [
  {
    ...
    price: 10,
    growth: 0.1,
    // desc: "Increases your growth rate by 0.2!",
  },
  {
    name: "Super Luck 🍀",
    price: 100,
    growth: 2,
    // desc: "Increases your growth rate by 2!",
  },
  {
    name: "Amazing Luck 🍀",
    price: 1000,
    growth: 50,
    // desc: "Increases your growth rate by 50!",
  },
  // {
  //   name: "Mystical Luck 🍀",
  //   price: 500,
  //   growth: 0,
  //   desc: "Increases your growth rate by 5 for 10 seconds!",
  // },
  // {
  //   name: "Mystery Luck 🎲",
  //   price: 50,
  //   growth: 0,
  //   desc: "Chance of winning either 500 meows or losing 100.. Buy at your own risk!",
  // },
];

const shopButtons: HTMLButtonElement[] = [];

const shopPurchases: number[] = [0, 0, 0];
let index = 0;
let growthRate = 1;
// let boost = false;
// const boosttime = 10000;
// const originalGrowthRate = growthRate;
for (const item of availableItems) {
  const shopButton = document.createElement("button");
  shopButton.disabled = true;
  app.append(shopButton);
  shopButton.textContent = `${item.name} - Price: ${item.price}`;
  shopButton.addEventListener("click", () =>
    handleClick(item, shopButton, shopCountDisplay),
  );
...
function handleClick(
  ...
  shopCountDisplay: HTMLDivElement,
) {
